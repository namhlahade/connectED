...
extension Tutor {
    static let previewData: [Tutor] = [
        ...
        Tutor(name: "Nick", email: "neel@duke.edu", courses: [], status: Status.online, isFavorite: true,  availability_days: [.tuesday, .thursday], availability_times: [[Date(), Date()], [Date(), Date()]]),
    ]
}
