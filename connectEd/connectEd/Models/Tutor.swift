...
extension Tutor {
    static let previewData: [Tutor] = [
        ...
        Tutor(name: "Namh", email: "namh@duke.edu", courses: [Course(subject: .egr, code: "101"), Course(subject: .ece, code: "661")], status: Status.offline, rating: 2.0, price: 5.00, reviews: [], isFavorite: false,  availability: []),
